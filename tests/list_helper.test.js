...
describe('total likes', () => {
  it('of only one blog, equals the likes of that', () => {
  ...
  it('of multiple blogs is calculated right', () => {
...
describe('favorite blog', () => {
  ...
  it('of single blog in list is that blog', () => {
...
describe('most likes', () => {
  ...
  it('of single blog in list is that author and their likes', () => {
    const result = listHelper.mostLikes(listWithOneBlog);
    assert.deepStrictEqual(result, { author: 'Edsger W. Dijkstra', likes: 5 });
  });

  it('of a long list is correct author and total likes', () => {
